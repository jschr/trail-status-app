...
const TermsOfService: React.FunctionComponent = () => {
  return (
    <Container maxWidth="md">
      ...
      <p>Welcome to Trail Status App!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Trail Status App's Website, located at https://trailstatusapp.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Trail Status App if you do not agree
      ...
      <p>
        We employ the use of cookies. By accessing Trail Status App, you agreed
        to use cookies in agreement with the Trail Status App's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Trail Status App and/or its licensors own the
        intellectual property rights for all material on Trail Status App. All
        intellectual property rights are reserved. You may access this from
        Trail Status App for your own personal use subjected to restrictions set
        in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Trail Status App</li>
        <li>Sell, rent or sub-license material from Trail Status App</li>
        <li>Reproduce, duplicate or copy material from Trail Status App</li>
        <li>Redistribute content from Trail Status App</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Trail
        Status App does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Trail Status App,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Trail Status App
      ...
      <p>
        Trail Status App reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Trail Status App a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Trail Status App; and (d) the
      ...
      <p>
        ...
        e-mail to Trail Status App. Please include your name, your organization
      ...
      <p>
        No use of Trail Status App's logo or other artwork will be allowed for
