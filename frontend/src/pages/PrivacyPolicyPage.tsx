...
const PrivacyPolicyPage = () => {
  return (
    <Container maxWidth="md">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Trail Status App.
          </p>
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Trail Status App, accessible from
      ...
      <ul>
        <li>By email: trailstatusapp@jschr.io</li>
      </ul>
    </Container>
  );
};
